...
RSpec.describe EventReportsController, type: :controller do
  ...
  # EventReport. As you add validations to EventReport, be sure to
  ...
  # EventReportsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all event_reports as @event_reports" do
      event_report = EventReport.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:event_reports)).to eq([event_report])
    end
  end
